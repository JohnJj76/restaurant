...
class _PostresState extends State<Postres> {
  //
  final CollectionReference _postres =
      FirebaseFirestore.instance.collection('postres');
                            ...
                            return GestureDetector(
                              onTap: () {
                                ...
                                Navigator.push(context,
                                  ...
                                  return PastaDetalle(food: postre);
                                }));
                              },
                              child: Container(
                                height: 50,
